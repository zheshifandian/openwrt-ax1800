...
if hwtype == "mac80211" then
	...
	celldensity = s:taboption("advanced", ListValue, "cell_density", translate("Coverage cell density"),
		translate("Configures data rates based on the coverage cell density. Normal configures basic rates to 6, 12, 24 Mbps " ..
			"if legacy 802.11b rates are not used else to 5.5, 11 Mbps. High configures basic rates to 12, 24 Mbps if legacy " ..
			"802.11b rates are not used else to the 11 Mbps rate. Very High configures 24 Mbps as the basic rate. Supported " ..
			"rates lower than the minimum basic rate are not offered."))
	...
	beaconint = s:taboption("advanced", Value, "beacon_int", translate("Beacon Interval"))
	beaconint.datatype = "range(15,65535)"
	beaconint.placeholder = "100"
end
